...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "FitLife — Kalkulator Kesehatan BMI, Berat Ideal & Kalori" },
      { property: "og:description", content: "Hitung BMI, berat badan ideal, dan kebutuhan kalori harianmu. Simpan riwayat, ekspor PDF, dan bagikan hasil secara instan." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "FitLife — Kalkulator Kesehatan BMI, Berat Ideal & Kalori" },
      { name: "twitter:description", content: "Hitung BMI, berat badan ideal, dan kebutuhan kalori harianmu. Simpan riwayat, ekspor PDF, dan bagikan hasil secara instan." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/acb8d1d4-9132-4532-87f4-5b2c63a55145" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/acb8d1d4-9132-4532-87f4-5b2c63a55145" },
    ],
    links: [
